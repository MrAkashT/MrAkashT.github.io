...
\firstname{Akash} % Your first name
\familyname{Thakar} % Your last name

% All information in this block is optional, comment out any lines you don't need
\title{Curriculum Vitae}
% \extrainfo{
%     \begin{CJK*}{UTF8}{gbsn}
%        XinYaanZyoy (心言自由) The Helper Boy
%     \end{CJK*}
% }
\address{B/503 Kalash Residency, Ghuma gam, Bopal}{Ahmedabad, Gujarat 380058}
\mobile{+91 846 056 6920}
% \phone{(000) 111 1112}
% \fax{(000) 111 1113}
\email{akash.thakar42@gmail.com}
% \homepage{XinYaanZyoy.github.io}{XinYaanZyoy.github.io} % The first argument is the url for the clickable link, the second argument is the url displayed in the template - this allows special characters to be displayed such as the tilde in this example
...
\cventry{2017--2021}{Bachelor of Engineering}{L.J. Institute of Engineering Technology}{Ahmedabad}{\textit{CGPA :- 9.36}}{Information Technology}
...
% \cvitem{Intermediate}{\textsc{python}, \textsc{javascript}, \textsc{html}, \LaTeX, Linux}
...
\cvitemwithcomment{Hindi}{Bilingual}{}
\cvitemwithcomment{English}{Intermediate}{}
% \cvitemwithcomment{sanskrit}{Basic}{Basic words and phrases only}
...
\cvlistdoubleitem{Dancing}{}
\cvlistdoubleitem{Gymnastics}{}
\cvlistitem{Adventure}
